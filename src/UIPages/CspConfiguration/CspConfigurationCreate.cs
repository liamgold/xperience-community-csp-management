...
internal class CspConfigurationCreate : CreatePage<CSPConfigurationInfo, CspConfigurationEditSection>
{
    public CspConfigurationCreate(IFormComponentMapper formComponentMapper, IFormDataBinder formDataBinder, IPageLinkGenerator pageLinkGenerator)
